...
public abstract class SectionedRecyclerViewAdapter<H extends RecyclerView.ViewHolder,
    ...
    private List<Integer> headerType = new ArrayList<>();
    private List<Integer> footerType = new ArrayList<>();
    ...
    public int getItemViewType(int position) {
        ...
        if (isSectionHeaderPosition(position)) {
            ...
            headerType.add(viewType);
        } else if (isSectionFooterPosition(position)) {
            footerType.add(viewType);
            viewType = getSectionFooterViewType(section);
        } else {
            viewType = getSectionItemViewType(section, index);
        }
        return viewType;
    }
    ...
    protected boolean isSectionHeaderViewType(int viewType) {
        return headerType.contains(viewType);
    }

    protected boolean isSectionFooterViewType(int viewType) {
        return footerType.contains(viewType);
    }
